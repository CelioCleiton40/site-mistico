...
export const FreeConsultation = () => {
    ...
    return (
        <section className="py-24 bg-[#150c1f] relative border-b border-[#d4af37]/20">
                ...
                <div className="flex flex-col md:flex-row items-center gap-12">
                    ...
                    <div className="w-full md:w-1/2 text-center md:text-left order-2 md:order-1">
                        <h2 className="font-luxury text-5xl text-[#d4af37] mb-6">
                            Consulta Espiritual Gratuita
                        </h2>

                        <p className="font-mystic text-2xl text-white leading-relaxed mb-4">
                            Descubra os caminhos que os oráculos reservam para você.
                        </p>

                        <p className="font-body text-lg text-gray-300 mb-6">
                            Não deixe suas dúvidas para depois. Entenda seu momento atual e receba o direcionamento espiritual que você precisa, totalmente sem custo.
                        </p>
                    ...
                    <div className="w-full md:w-1/2 order-1 md:order-2">
                        <div className="relative rounded-2xl overflow-hidden border-2 border-[#d4af37]/30 shadow-[0_0_30px_rgba(212,175,55,0.15)]">
                            <video
                                ref={videoRef}
                                src="/consulta gratis.mp4"
                                poster="/medioevidente.jpeg"
